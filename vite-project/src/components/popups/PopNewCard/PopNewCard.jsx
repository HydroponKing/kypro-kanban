      ...
      <div className="pop-new-card__block">
        <div className="pop-new-card__content">
          ...
          <div className="pop-new-card__wrap">
            <form action="#" className="pop-new-card__form form-new" id="formNewCard">
            ...
            <div className="pop-new-card__calendar calendar">
              ...
              <div className="calendar__block">
                <div className="calendar__nav">
                  ...
                  <div className="nav__actions">
                    <div className="nav__action" data-action="prev">
                      <svg height="11" viewBox="0 0 6 11" width="6" xmlns="http://www.w3.org/2000/svg">
                ...
                <input defaultValue="08.09.2023" id="datepick_value" type="hidden" />
            ...
            <div className="theme-down__categories theme-down">
              ...
              <div className="categories__themes">
                <div className="categories__theme _orange">
                  <p className="_orange">Web Design</p>
                </div>
                <div className="categories__theme _hide">
                  <p>Mobile Design</p>
                </div>
                <div className="categories__theme _hide">
                  <p>SEO</p>
            ...
            <div className="pop-new-card__btn">
